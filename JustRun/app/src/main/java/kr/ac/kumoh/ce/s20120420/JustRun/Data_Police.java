 ...
 */
public class Data_Police implements Serializable {
    ...
    List<location> enermy;
    List<location> item;
    List<location> zone;
    List<String> partner_nic;

    public Data_Police(int range, int zone_num, int item_num, int partner_num, int enermy_num,int room_num,double la,double lo,double la2,double lo2,int index,int game_time) {
        ...
        this.enermy_num=enermy_num;
        this.my_index=index;
        partner= new ArrayList<location>();
        enermy= new ArrayList<location>();
    ...
    public List<location> getEnermy() {
        return enermy;
    }
    ...
    public void setEnermy(double la,double lo) {
        this.enermy.add(new location(la,lo));
    }
